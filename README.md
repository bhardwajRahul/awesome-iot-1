...
- [PiSpot Show](https://github.com/GeiserX/PiSpot-Show) - A Raspberry Pi appliance that drives hotel lobby TVs and public-area monitors, generating hourly Wi-Fi voucher codes with live weather overlays, rendered directly to the framebuffer. Features PiJuice HAT battery management for unattended 24/7 operation.
- [PiSpot Watch](https://github.com/GeiserX/PiSpot-Watch) - A wrist-wearable IoT device built with a Raspberry Pi Zero and PaPiRus e-ink display that generates time-limited Wi-Fi voucher codes on demand via button presses, designed for hotel and venue staff.
